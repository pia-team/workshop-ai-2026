...
| 4 | [Beyza Nur Tiril](https://github.com/beyzanurtiril) | [makeup-agent](https://github.com/beyzanurtiril/makeup-agent) | Python, Gemini API, Tavily | An agent that recommends cool-toned makeup products by category (lipstick, eyeshadow, concealer, etc.) using real-time web search. |
